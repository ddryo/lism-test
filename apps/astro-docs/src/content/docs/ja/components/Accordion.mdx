...
import { Stack, Alert, Note, Text, Center, Flex, Icon,
// 
AccordionGroup, Accordion, AccordionHeader, AccordionBody, AccordionLabel, AccordionIcon 
 } from '@loos/lism-core';
// import { AccordionGroup, Accordion, AccordionHeader, AccordionBody, AccordionLabel, AccordionIcon } from '@loos/lism-astro';
