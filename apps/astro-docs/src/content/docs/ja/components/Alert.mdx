...
また、`.is--colorbox`との併用によって、keycolorから背景色やボーダー色を自動生成します。
...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		```jsx
		<div class="c--alert l--sideFlex is--colorbox -bdrs:2" data-side="first">
...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		```jsx "is--colorbox" "-keycolor:"
		<div class="c--alert l--sideFlex is--colorbox -keycolor:blue -bdrs:2" data-side="first">
			<div class="c--alert__body">
				<p>ロレムイプサムの座り雨、トマ好き学習だったエリット、しかし時と活力はそのような木々と楽しみ。</p>
			</div>
		</div>
...
```
	...
	<PreviewCode slot='tab' label='HTML'>
		```jsx {2-4,11-13} "is--colorbox" "-keycolor:" "c--alert__icon e--icon"
		<div class="c--alert l--sideFlex is--colorbox -keycolor:pink -bdrs:2" data-side="first">
