...
import { Box, TileGrid, Card, CardMedia, CardBody, Alert, Badge, Grid, Stack, Text, FlexItem, OverlayLink, FilterLayer, Button, Columns, Media } from '@loos/lism-core';
...
<Preview>
	<PreviewTitle>リンクあり、内部にもリンクあり。</PreviewTitle>
	<PreviewArea resize p={20}>
		<Card href='#card-demo' bdrs='l'>
			<CardMedia aspect='16/9'>
				<Media src='/img.jpg' alt='' width='960' height='640' />
			...
			<CardBody>
				<h3 className='-fz:l'>
					<OverlayLink href='#boxlink02'>Card Heading(Link)</OverlayLink>
				</h3>
				<DammyText />
				<Text ta='right' mt='auto' fz='s'>Bottom Text</Text>
			</CardBody>
	...
	<PreviewArea resize p={20}>
		<TileGrid itemMinW='20rem' gap={20}>
			<Card href='#card-demo' bdrs='xs' hover={['bxsh:4', 'up', 'mediaBright']}>
				<CardMedia aspect='2/1'>
					<Media className='is--transitionMedia' src='/img.jpg' alt='' width='960' height='640' />
					<Badge boxcolor='black' pos='absolute' top='0' right='0'>Category</Badge>
				</CardMedia>
				<CardBody lh='s'>
					<h3 className='-fz:l'>Card Title A</h3>
					<DammyText />
...
<Preview>
	...
	<PreviewArea p={30}>
		<Card bxsh='3'>
			...
			<CardBody isLayer inset='0'>
				<Stack h='100%' gap={20}>
					<h3 className='-fz:l'>Card Title</h3>
					<DammyText />
					<Button className='is--end' href='#button-test' radius='99' hover='fade' mt='auto' flexIterm={{aslf:'fe'}}>Button</Button>
				</Stack>
			</CardBody>
		</Card>
	</PreviewArea>
...
<Preview>
	...
	<PreviewArea resize p={20}>
		<TileGrid itemMinW='20rem' gap={20}>
			<Card href='#card-demo' bdrs='xs' hover={['contentUp', 'mediaZoom']}>
				<CardMedia aspect='4/3'>
					<img src='/img.jpg' alt='' width='960' height='640' />
				</CardMedia>
