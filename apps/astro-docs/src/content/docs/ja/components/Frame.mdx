...
description: ...
---
import { Box, Flex, Media, Text, MediaLayer, FilterLayer, Frame, Center, Columns, Layer } from '@loos/lism-core';
...
[`is--frame`](/ja/css/design-state/#is--frame)をデフォルトで出力するモジュールです。
...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		...
		<div
			...
			style="--aspect--sm:4/3;--aspect--md:16/9"
		>...</div>
		```
	</PreviewCode>
</Preview>
