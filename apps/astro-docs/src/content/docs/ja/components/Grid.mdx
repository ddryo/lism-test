...
<Preview>
	...
	<PreviewArea resize p={20}>
		<Grid gtc='1fr auto 1fr'>
			<GridItem as={Center} p={20} bgc='base-2'>item1</GridItem>
			<GridItem as={Center} p={20} bgc='base-2'>item2</GridItem>
			<GridItem as={Center} p={20} bgc='base-3'>item3</GridItem>
			<GridItem as={Center} p={20} bgc='base-3'>item4</GridItem>
			<GridItem as={Center} p={20} bgc='base-2'>item5</GridItem>
			<GridItem as={Center} p={20} bgc='base-2'>item6</GridItem>
