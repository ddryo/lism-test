...
<Preview>
	...
	<PreviewArea resize p={10}>
		<LinkBox href='#boxlink01' p='box:l' bgc='base' bdc='table' bd bdrs='4'>
	...
	<PreviewCode slot='tab' label='HTML'>
		```jsx
		<a class="is--linkBox -hov:fade -p:box:l -bgc:base -bd: -bdc:table -bdrs:l" href="#boxlink01">
...
<Preview>
	...
	<PreviewArea p={30}>
		<LinkBox p='box:l' bgc='base' bdc='table' bd bdrs='4'>
			<Text fz='xl' fw='bold'>
	...
	<PreviewCode slot='tab' label='HTML'>
		...
		<div class="is--linkBox -hov:fade -p:box:l -bgc:base -bd: -bdc:table -bdrs:l">
...
<Preview>
	...
	<PreviewArea p={30}>
		<LinkBox href='#boxlink03' tag='div' p='box:l' bgc='base' bdc='table' bd bdrs='4'>
			<Text fz='xl' fw='bold'>Heading Text</Text>
			<DammyText length='m' c='content-2' lh='s' mbs={20} />
	...
	<PreviewCode slot='tab' label='React, Astro'>
		...
		<LinkBox href='#boxlink03' tag='div' p='box:l' bgc='base' bdc='divider' bd bdrs='4'>
			<Text fz='xl' fw='bold'>Heading Text</Text>
			<Text c='content-2' lh='s' mbs={20}>
				Lorem ipsum dolor sit, amet consectetur adipisicing elit, sed do eiusmod tempor. Non facere laudantium ex eos doloribus aut dolore nisi provident.
			</Text>
