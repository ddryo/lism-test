...
import { Item, Reel, Frame, Box, Columns, Cluster } from '@loos/lism-core';
...
```jsx
import { Reel } from '@loos/lism-astro';
```
	</PreviewCode>
</Preview>
	...
	return (
		<>
			{Array.from({length: 6}, (v, i) => i).map((i) => {
				// 偶数かどうか
				const isEven = i % 2 === 0;
				return <Box bgc={isEven ? 'b100' : 'b200'} p="box" key={i}>
					<p>Box</p>
				</Box>
			})}
		</>
...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
		...
		<div class="l--reel" tabindex="0">
			<div class="l--box -bgc:pale -p:box">Box</div>
			<div class="l--box -bgc:pale -p:box">Box</div>
			...
		</div>
		```
...
<Preview>
	...
	<PreviewArea p={20} isShadow={false} isFlow='s'>
		...
		<Cluster gap={20} jc='c' lh='1'>
			<Item tag='a' href='#image-1' c='base' bgc='b200' p='box:s' radius='2' hover={{bgc: 'b300'}} td='none'>1</Item>
			<Item tag='a' href='#image-2' c='base' bgc='b200' p='box:s' radius='2' hover={{bgc: 'b300'}} td='none'>2</Item>
			<Item tag='a' href='#image-3' c='base' bgc='b200' p='box:s' radius='2' hover={{bgc: 'b300'}} td='none'>3</Item>
			<Item tag='a' href='#image-4' c='base' bgc='b200' p='box:s' radius='2' hover={{bgc: 'b300'}} td='none'>4</Item>
			<Item tag='a' href='#image-5' c='base' bgc='b200' p='box:s' radius='2' hover={{bgc: 'b300'}} td='none'>5</Item>
			<Item tag='a' href='#image-6' c='base' bgc='b200' p='box:s' radius='2' hover={{bgc: 'b300'}} td='none'>6</Item>
		</Cluster>
	</PreviewArea>
	<PreviewCode>
		```jsx
...
<Preview>
	...
	<PreviewArea resize p={20}>
		<Box maxW='24rem' mx='a'>
			<Reel fxd='column' itemW='auto' aspect='3/4.5' radius='4' bgc='black' p={30} gap={30}>
				<ReelImages isV radius='3' />
			</Reel> 
		</Box>
	</PreviewArea>
	<PreviewCode>
