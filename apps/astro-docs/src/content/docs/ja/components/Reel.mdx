...
<Preview>
	...
	<PreviewArea p={20} isShadow={false} isFlow='s'>
		...
		<Cluster gap={20} jc='c' lh='1'>
			<Item tag='a' href='#image-1' c='inherit' bgc='base-3' p='box:s' bdrs='s' hover='bgc'>1</Item>
			<Item tag='a' href='#image-2' c='inherit' bgc='base-3' p='box:s' bdrs='s' hover='bgc'>2</Item>
			<Item tag='a' href='#image-3' c='inherit' bgc='base-3' p='box:s' bdrs='s' hover='bgc'>3</Item>
			<Item tag='a' href='#image-4' c='inherit' bgc='base-3' p='box:s' bdrs='s' hover='bgc'>4</Item>
			<Item tag='a' href='#image-5' c='inherit' bgc='base-3' p='box:s' bdrs='s' hover='bgc'>5</Item>
			<Item tag='a' href='#image-6' c='inherit' bgc='base-3' p='box:s' bdrs='s' hover='bgc'>6</Item>
		</Cluster>
	</PreviewArea>
	<PreviewCode>
		```jsx
...
<Preview>
	...
	<PreviewArea resize p={20}>
		<Box maxW='24rem' mx='a'>
			<Reel fxd='column' itemW='auto' aspect='3/4.5' bdrs='l' bgc='black' p={30} gap={30}>
