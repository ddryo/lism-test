...
|Prop|CSS Property|Token|To Class|BP|
|---|---|---|---|---|
|w|width|`SIZE`|`100`,`fit`|○|
|h|height|`SIZE`|`100`,`fit`,`screen`|○|
|maxW|max-width|`SIZE`|100|-|
|maxH|max-height|`SIZE`|100|-|
|minW|min-width|`SIZE`||-|
|minH|min-height|`SIZE`||-|
...
|[flex\|grid]colg|column-gap|SPACE|---|○|
...
|Prop|CSS Property|Token,To Class|
|---|---|---|
