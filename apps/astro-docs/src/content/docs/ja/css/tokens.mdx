...
import { Core, Box, Text, Stack, Flex, Columns, Frame, Alert, Note, Tabs, TabItem, Spacer } from '@loos/lism-astro';


export const ColorBadge = ({color, label}) => {
	return <span className='-d:f -ai:c -gap:em3'>
			<Core tag='span' className='has--size -d:ib' size='1.5em' bgc={color} bdrs='s' bxsh='1' />
...
|パレットトークン|変数|クラス|
|---|---|---|
|<ColorBadge color='red' />|`--red`|`.-keycolor:red`|
|<ColorBadge color='orange' />|`--orange`|`.-keycolor:orange`|
|<ColorBadge color='yellow' />|`--yellow`|`.-keycolor:yellow`|
|<ColorBadge color='green' />|`--green`|`.-keycolor:green`|
|<ColorBadge color='blue' />|`--blue`|`.-keycolor:blue`|
|<ColorBadge color='purple' />|`--purple`|`.-keycolor:purple`|
|<ColorBadge color='pink' />|`--pink`|`.-keycolor:pink`|
|<ColorBadge color='black' />|`--black`|`.-keycolor:black`|
|<ColorBadge color='white' />|`--white`|`.-keycolor:white`|


<Preview>
	<PreviewTitle>使用例</PreviewTitle>
	<PreviewArea p={20}>
		<Alert preset='alert'><DammyText length='codes' /></Alert>
		<Note preset='note' heading='Note'><DammyText length='codes' /></Note>
		<Box className='is--colorbox' keycolor='blue' bd p='box'>
			<DammyText length='codes' />
		</Box>
		<Box bgc='green:15%' c='blue:50%' p='box'>
			<DammyText />
		</Box>
	</PreviewArea>
</Preview>
...
|構成変数|初期値|
|---|---|
|`--shColor`|`hsl(215 8% 8% / 8%)`|
|`--shSize-0`|`0.5px 1px 1px 0`|
|`--shSize-1`|`1px 2px 3px 0`|
|`--shSize-2`|`2px 4px 7px 0`|
|`--shSize-3`|`4px 8px 15px 0`|
|`--shSize-4`|`8px 16px 31px 0`|


{/* <Preview>
	<PreviewTitle>shadows</PreviewTitle>
	<PreviewArea p={40} nogrid>
		<Columns cols={[2, 3, 5]} gap={50}>
			<ShadowDemos shadows={[ 1, 2, 3, 4, 5 ]}/>
		</Columns>
	</PreviewArea>
</Preview> */}
...
<Preview>
	...
	<PreviewArea p={40} nogrid>
		<Columns cols={[2, 4, 4]} gap={50}>
			<BoxShadowDemos shadows={[ 1, 2, 3, 4 ]}/>
		</Columns>
	</PreviewArea>
		<PreviewCode slot='tab' label='CSS'>
```css
/* 内部の構成イメージ */
.-bxsh\:1 {box-shadow: var(--shSize-0) var(--shColor), var(--shSize-1) var(--shColor)}
.-bxsh\:2 {box-shadow: var(--shSize-1) var(--shColor), var(--shSize-2) var(--shColor)}
.-bxsh\:3 {box-shadow: var(--shSize-2) var(--shColor), var(--shSize-3) var(--shColor)}
.-bxsh\:4 {box-shadow: var(--shSize-3) var(--shColor), var(--shSize-4) var(--shColor)}
```
	</PreviewCode>
	<PreviewCode slot='tab' label='HTML'>
		```jsx
...
```css
/* 内部の構成イメージ */
.-bxsh\:-1 {box-shadow: inset var(--shSize-0) var(--shColor), inset var(--shSize-1) var(--shColor)}
.-bxsh\:-2 {box-shadow: inset var(--shSize-1) var(--shColor), inset var(--shSize-2) var(--shColor)}
.-bxsh\:-3 {box-shadow: inset var(--shSize-2) var(--shColor), inset var(--shSize-3) var(--shColor)}
.-bxsh\:-4 {box-shadow: inset var(--shSize-3) var(--shColor), inset var(--shSize-4) var(--shColor)}
```
	</PreviewCode>
	<PreviewCode slot='tab' label='HTML'>
		```jsx
...
bxshユーティリティの構成変数である `--shColor` を上書き指定することで、シャドウカラーを変更することができます。

{/* color-mix(in srgb, blue, transparent 80%) */}
<Preview>
	<PreviewTitle>`--shColor`の上書き</PreviewTitle>
	<PreviewArea p={40} nogrid>
		<Box bxsh='3' shColor='rgb(100 100 200 / 20%)' p='40' >...</Box>
	</PreviewArea>
	<PreviewCode slot='tab' label='HTML'>
		```jsx "--shColor:"
		<div class="l--box -bxsh:3 -p:40" style="--shColor:rgb(100 100 200 / 20%)"> … </div>
		```
	</PreviewCode>
</Preview>
