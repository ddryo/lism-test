...
<Preview>
	...
	<PreviewArea resize p={20}>
		<Frame aspect='16/9' bg="url(/img.jpg) center / 50%">
...
<Preview>
	...
	<PreviewArea resize p={20}>
		<Frame aspect='16/9' bg={{image: 'url(/img.jpg)', position: 'center', size: '50%'}}>
			<Layer bgc="white:50%" position="center" size="contain" w="40rem" p="box">
				<DammyText />
			</Layer>
		</Frame>
...
<Preview>
	...
	<PreviewArea resize p={20}>
		<Frame aspect='16/9'>
			...
			/>
			<Layer p={20} inset={0}>
				<Center p='box' size='cover' bg='glass' c='white' bdrs='s' bxsh={2}>
					<DammyText />
				</Center>
			</Layer>
		</Frame>
		<Frame aspect='16/9'>
			...
			/>
			<Layer p={20} inset={0}>
				<Center p='box' size='cover' bg='glass' c='black' bdrs='xl' bxsh={4}>
					<DammyText />
				</Center>
			</Layer>
		</Frame>
