...
<Preview>
	...
	```html "-hov:"
	<a class="c--linkbox -hov:fade -p:box -bgc:base-2 -bd:" href="###">
		...
	</a>
	```
	</PreviewCode>
...
<Preview>
	<PreviewTitle>`hover='bxsh:4'`</PreviewTitle>
	<PreviewArea p={40}>
		<PreviewBoxs hover='bxsh:4'/>
	</PreviewArea>
	<PreviewCode slot='tab' label='React, Astro'>
	```jsx "hover="
	<LinkBox hover='bxsh:4' href='###' p='box'>
		...
	</LinkBox>
	```
	</PreviewCode>
	<PreviewCode slot='tab' label='HTML'>
	```html "-hov:"
	<a class="c--linkbox -hov:bxsh:4 -p:box -bgc:base-2 -bd:" href="###">
		...
	</a>
	```
	</PreviewCode>
...
<Preview>
	...
	<PreviewCode slot='tab' label='HTML'>
	```html "-hov:"
	<a class="c--linkbox -hov:up -p:box -bgc:base-2 -bd:" href="###">
		...
	</a>
	```
	</PreviewCode>
...
<Preview>
	<PreviewTitle>`hover='up,bxsh:3'`</PreviewTitle>
	<PreviewArea p={40}>
		<PreviewBoxs hover='up,bxsh:3'/>
	</PreviewArea>
	<PreviewCode slot='tab' label='React, Astro'>
	```jsx "hover="
	<LinkBox hover='up,bxsh:3' href='###' p='box'>
		...
	</LinkBox>
	```
	</PreviewCode>
	<PreviewCode slot='tab' label='HTML'>
	```html "-hov:"
	<a class="c--linkbox -hov:up -hov:bxsh:3 -p:box -bgc:base-2 -bd:" href="###">
		...
	</a>
	```
	</PreviewCode>
...
`c`,`bgc`,`bdc`,`bxsh`, `shColor`, `filter` に変化後の値を指定することができ、より柔軟にhover時の挙動を指定できます。
...
<Preview>
	...
	<a
		class="c--linkbox -hov:bgc -hov:c -bgc:base-2 -p:box"
...
<Preview>
	<PreviewTitle>Shadow</PreviewTitle>
	<PreviewArea p={40}>
		<LinkBox href='###' hover='bxsh:4' bgc='base-2' p='box'>
			<Text>LinkBox.</Text>
			<Text>shadow 0 から shadow つける</Text>
		</LinkBox>
		<LinkBox href='###' hover='bxsh:0' bxsh='4' bgc='base-2' p='box'>
			<Text>LinkBox.</Text>
			<Text>hoverで shadow0</Text>
		</LinkBox>
		<LinkBox href='###' hover={{ bxsh: '2', shColor: 'blue:20%'}} bxsh='4' bgc='base-2' p='box'>
			<Text>LinkBox.</Text>
			<Text>Lorem ipsum dolor sit amet consectetur adipisicing elit.</Text>
		</LinkBox>
		<LinkBox href='###' hover={{ bxsh: '4', shColor: 'red:20%'}} bxsh='0 0 8px rgb(0 0 0 / 25%)' bgc='base-2' p='box'>
			<Text>カスタムシャドウからプリセット.</Text>
			<Text>Lorem ipsum dolor sit amet consectetur adipisicing elit.</Text>
		</LinkBox>
		<LinkBox href='###' hover={{ bxsh: '0 0 16px'}} bxsh='0 0 4px' bgc='base-2' p='box'>
			<Text>カスタムシャドウ→カスタムシャドウ</Text>
			<Text>Lorem ipsum dolor sit amet consectetur adipisicing elit.</Text>
		</LinkBox>
	</PreviewArea>
	<PreviewCode>
	```jsx "hover=" "bxsh:'2'" "bxsh='4'"
		<LinkBox href='###' hover={{ shSize:'1'}} bxsh='4' bgc='base-2' p='box' >...</LinkBox>
	```
	</PreviewCode>
</Preview>

（shColorの指定はプリセット使用時のみ有効です。）

{/* <HelpText>bxshのトークン値は変数があるわけではなく、ユーティリティクラスが用意されているだけであることに注意してください。</HelpText> */}

<Preview>
	<PreviewTitle>Shadow (inset)</PreviewTitle>
	<PreviewArea p={40}>
		<LinkBox href='###' hover={{ bxsh:'-1' }} bxsh='-3' bgc='base-2' p='box'>
			<Text>LinkBox.</Text>
			<Text>Lorem ipsum dolor sit amet consectetur adipisicing elit.</Text>
		</LinkBox>
	</PreviewArea>
	<PreviewCode>
	```jsx "hover=" "bxsh:" "bxsh='-3'"
		<LinkBox href='###' hover={{ bxsh:'-1' }} bxsh='-3' bgc='base-2' p='box'>...</LinkBox>
	```
	</PreviewCode>
</Preview>
...
<Preview>
	...
	<PreviewArea p={20}>
		<Banner hover='pass' href='#banner-link' aspect='16/9' bdrs='l'>
