...
<Demo>
	<Demo.Title>メディア側にBadge追加, hoverを変えてみる</Demo.Title>
	<Demo.Preview resize p={20}>
		<TileGrid itemMinW="20rem" gap={20}>
...
<Demo>
	<Demo.Title>横並びの方向を 逆順にして、リンクも設定する</Demo.Title>
	<Demo.Preview p={20} maxW="40em">
...
<Demo>
	<Demo.Title>`w:32%`, `aspect:3/4`, 位置反転</Demo.Title>
...
{/* <Demo>
	<Demo.Title>rtl言語でのテスト</Demo.Title>
	<Demo.Preview p={20} maxW="40em">
		<Card isFlex dir='rtl'>
			<CardMedia w="40%">
				<Image src="/img/demo-img.jpeg" alt="" width={960} height={640} />
