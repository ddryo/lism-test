import { Container, Section, SectionBody, SectionHeader, SectionFooter } from '@lism/core';
...
```js
import { Section, SectionBody, SectionHeader, SectionFooter } from '@lism/core';
```
...
<Demo>
	...
	<Demo.Preview resize alignfull p={{ Y: 50 }}>
