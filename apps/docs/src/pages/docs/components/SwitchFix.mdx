...
<Note preset="memo" caption={<><a href="/docs/components/FluidFix">{`<FluidFix>`}</a>と異なる点</>}>
...
<Demo>
	...
	<Demo.Preview resize p={20}>
		<SwitchFix breakPoint="md" fix="left down" fixW='16em' gap={20} lismState={["has--itemGuide"]}>
			<Item>Main Contents</Item>
			<Item ga="fix" bgc="pale">Side</Item>
		</SwitchFix>
	</Demo.Preview>
