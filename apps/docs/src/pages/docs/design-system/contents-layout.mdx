import { Container, Box, Text, Center, Columns, Layer } from '@lism/core';
...
<Note preset='success' caption='次の位置でのネストは問題ありません'>
...
<Demo>
	<Demo.Title>NG: `flowGap`を指定した直下で さらに`is--flow`を配置</Demo.Title>
	<Demo.Preview resize p={30}>
