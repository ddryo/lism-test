...
paddingやmargin, gap等で利用できます。(p,py,px,pl,pr,pt,pb,m,my,mx,ml,mr,mt,mb,gap, columnGap, rowGap,top,left,bottom,right,inset)
...
<Demo>
	<Demo.Title>DEMO</Demo.Title>
	<Demo.Preview nogrid p={20} flowGap='s'>
		<SpacingDemos spaces={['em1','em2','em3','em4','em5','em10','em15','em20','em25','em30']} isValueLabel />
	</Demo.Preview>
</Demo>
