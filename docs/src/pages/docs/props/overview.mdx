...
<Note caption="Lismコンポーネント以外では使用できません。" preset="warning">
...
```jsx
<div class="-p:20 -bxsh:2 -mb:" style="--mb:var(--space--40)">...</div>
```
...
```html
<div class="l--box -p:20 -p@sm: -p@md:" style="--p--sm:var(--space--30);--p--md:var(--space--40)">
	...
</div>
```
<Demo>
...
```html
<div class="l--box -p:20 -p@md:" style="--p--md:var(--space--40)">
	...
</div>
```
